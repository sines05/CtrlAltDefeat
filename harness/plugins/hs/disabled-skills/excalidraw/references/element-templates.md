...
Copy-paste JSON templates for `.excalidraw` files. Colors: `color-palette.md`.
...
```json
{
  ...
  "isDeleted": false,
  "groupIds": [],
  "boundElements": [{"id": "dtext1", "type": "text"}],
  "link": null,
  "locked": false
}
```
...
```json
{
  ...
  "isDeleted": false,
  "groupIds": [],
  "boundElements": [{"id": "stext1", "type": "text"}],
  "link": null,
  "locked": false
}
```

## Zone / dashed group rectangle
