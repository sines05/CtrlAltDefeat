...
1. **Screenshots provided** → Use `hs:ai-multimodal` skill to analyze context
2. **Videos provided** → Use `hs:ai-multimodal` video-analysis for context
3. **Write** → Use `hs:developer` agent directly to produce copy
