...
Claude Code exposes platform Agent Teams events, but the harness does not ship custom handlers for those events by default. Keep orchestration explicit until a live harness validates any hook-based flow.
