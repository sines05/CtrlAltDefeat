...
5. Load `references/sepay/best-practices.md` + `references/sepay/best-practices-flows.md` + `references/sepay/best-practices-advanced.md` for production readiness
...
7. Load `references/polar/best-practices.md` + `references/polar/best-practices-advanced.md` for production readiness
...
3. Implement per SKILL.md's General flow
