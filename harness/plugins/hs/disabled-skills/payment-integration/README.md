...
│   │   ├── best-practices.md    # Env config, tx format, QR, checkout API, webhooks
│   │   ├── best-practices-flows.md    # Order matching, tx processing, currency, invoice email
│   │   └── best-practices-advanced.md # Error handling, testing, schema, prod checklist, pitfalls
...
│   │   ├── best-practices.md    # Env config, checkout flow, webhooks, fee calc
│   │   └── best-practices-advanced.md # Discounts, revenue tracking, error handling, schema, testing, prod checklist, pitfalls
...
```bash
cd "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/payment-integration/scripts
