...
## Prerequisites
- Activate `hs:ui-ux` skill first for design intelligence
- Have `hs:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `hs:ai-multimodal` skill to extract:
