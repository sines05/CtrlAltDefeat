...
```bash
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --prompt "settings gear" --style outlined
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --prompt "shopping cart" --style filled --color "#6366F1"
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --name "dashboard" --category navigation --style duotone
```

### Generate Batch Variations

```bash
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --prompt "cloud upload" --batch 4 --output-dir ./icons
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --prompt "notification bell" --batch 6 --style outlined --output-dir ./icons
```

### Generate Multiple Sizes

```bash
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --prompt "user profile" --sizes "16,24,32,48" --output-dir ./icons
```

### List Styles/Categories

```bash
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --list-styles
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/icon/generate.py --list-categories
```
