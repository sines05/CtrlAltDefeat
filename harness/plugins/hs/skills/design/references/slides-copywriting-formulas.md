...
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design-system/scripts/search-slides.py "problem agitation" -d copy

# Get emotion-appropriate formula
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design-system/scripts/search-slides.py "urgency cta" -d copy
```
