...
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design-system/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design-system/scripts/search-slides.py "series a funding" -d strategy --json
```
