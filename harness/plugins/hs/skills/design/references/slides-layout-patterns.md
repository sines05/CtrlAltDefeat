...
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design-system/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design-system/scripts/search-slides.py "traction slide" \
