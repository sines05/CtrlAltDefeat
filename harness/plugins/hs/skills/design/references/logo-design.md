...
```bash
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/logo/search.py "tech startup modern" --design-brief -p "BrandName"
```
...
```bash
# Styles
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/logo/search.py "minimalist clean" --domain style

# Color palettes
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/logo/search.py "tech professional" --domain color

# Industry guidelines
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/logo/search.py "healthcare medical" --domain industry
```
...
```bash
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/logo/generate.py --brand "TechFlow" --style minimalist --industry tech
python3 "${HARNESS_BIN_ROOT:-.}"/harness/plugins/hs/skills/design/scripts/logo/generate.py --prompt "coffee shop vintage badge" --style vintage
```
...
4. If yes, invoke `/hs:ui-ux` for HTML gallery
