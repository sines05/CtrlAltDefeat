...
# Shared loader lives in compression_evaluator (single copy, same-dir sibling).
from compression_evaluator import load_file
...
def main():
    ...
    if args.command == "analyze":
        ...
        data = load_file(args.context_file, max_mb=MAX_FILE_SIZE_MB)
