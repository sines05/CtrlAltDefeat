...
Installation, environment setup, server + client setup, database schema, API handler mounting, and basic usage: [`getting-started.md`](./references/getting-started.md).
