...
def find_api_key():
    ...
    if api_key:
        ...
        print_info("python resolve_env.py GEMINI_API_KEY --skill ai-multimodal --verbose")
        return api_key
...
def provide_setup_instructions():
    ...
    print(f"   $ echo 'GEMINI_API_KEY=your-api-key-here' >> ~/.env")
    ...
    print("\n4. Debug if needed:")
    print(f"   $ python resolve_env.py --show-hierarchy --skill ai-multimodal")
    print(f"   $ python resolve_env.py GEMINI_API_KEY --skill ai-multimodal --verbose")
