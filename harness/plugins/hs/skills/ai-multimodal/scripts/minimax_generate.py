...
def _save_output_file(src, output):
    """Copy a generated file to the user-requested output path (parent created)."""
...
def generate_image(api_key: str, prompt: str, model: str = 'image-01',
    ...
    if output and saved_files:
        _save_output_file(saved_files[0], output)
...
def generate_video(api_key: str, prompt: str, model: str = 'MiniMax-Hailuo-2.3',
    ...
    if output:
        _save_output_file(output_path, output)
